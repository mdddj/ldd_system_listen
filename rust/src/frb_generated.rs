    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let mut deserializer =
                flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_level =
                <crate::api::level_filter::LddLevelFilter>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok =
                        Result::<_, ()>::Ok(crate::api::logger::MyMobileLogger::new(api_level))?;
                    Ok(output_ok)
                })())
            }
        },
...
impl SseDecode for crate::api::level_filter::LddLevelFilter {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut inner = <i32>::sse_decode(deserializer);
        return match inner {
            0 => crate::api::level_filter::LddLevelFilter::Off,
            1 => crate::api::level_filter::LddLevelFilter::Error,
            2 => crate::api::level_filter::LddLevelFilter::Warn,
            3 => crate::api::level_filter::LddLevelFilter::Info,
            4 => crate::api::level_filter::LddLevelFilter::Debug,
            5 => crate::api::level_filter::LddLevelFilter::Trace,
            _ => unreachable!("Invalid variant for LddLevelFilter: {}", inner),
        };
    }
}
...
impl SseDecode for crate::api::logger::MyMobileLogger {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_level = <crate::api::level_filter::LddLevelFilter>::sse_decode(deserializer);
        return crate::api::logger::MyMobileLogger { level: var_level };
    }
}
...
impl SseDecode for crate::api::logger::SendToDartLogger {
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_level = <crate::api::level_filter::LddLevelFilter>::sse_decode(deserializer);
        return crate::api::logger::SendToDartLogger { level: var_level };
    }
}
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        2 => wire__crate__api__multiinput__LddKeyboardManager_listen_ldd_keyboard_event_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        6 => wire__crate__api__logger__init_logger_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__logger__my_mobile_logger_new_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__logger__rust_set_up_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__logger__send_to_dart_logger_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        12 => wire__crate__api__logger__send_to_dart_logger_set_stream_sink_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        1 => wire__crate__api__multiinput__LddKeyboardManager_get_ldd_keyboard_list_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        3 => wire__crate__api__multiinput__LddKeyboardManager_new_impl(ptr, rust_vec_len, data_len),
        4 => wire__crate__api__multiinput__LddKeyboardManager_register_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        8 => wire__crate__api__entitys__ldd_state_format_string_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::level_filter::LddLevelFilter {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::level_filter::LddLevelFilter
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::level_filter::LddLevelFilter>
    for crate::api::level_filter::LddLevelFilter
{
    fn into_into_dart(self) -> crate::api::level_filter::LddLevelFilter {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
impl SseEncode for crate::api::level_filter::LddLevelFilter {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(
            match self {
                crate::api::level_filter::LddLevelFilter::Off => 0,
                crate::api::level_filter::LddLevelFilter::Error => 1,
                crate::api::level_filter::LddLevelFilter::Warn => 2,
                crate::api::level_filter::LddLevelFilter::Info => 3,
                crate::api::level_filter::LddLevelFilter::Debug => 4,
                crate::api::level_filter::LddLevelFilter::Trace => 5,
                _ => {
                    unimplemented!("");
                }
            },
...
impl SseEncode for crate::api::logger::MyMobileLogger {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <crate::api::level_filter::LddLevelFilter>::sse_encode(self.level, serializer);
    }
}
